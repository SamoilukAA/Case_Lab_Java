# Case_Lab_Java
# 1. Описание решения
Реализован микросервис на Spring Boot, который выполняет роль хранилища файлов и их атрибутов. При выполнении post-запроса файл и его аттрибуты сохраняются в БД PostgreSQL. При выполнении get-запроса микросервис возвращает данные в формате json.  
